    ...
    return (
        <article className="about-us">
            ...
            <section className="double-image">
                <img className="about-1" src={require('../../../assets/res.jpg')} alt="Little Lemon restaurant cuisine 1"></img>
                <img className="about-2" src={require('../../../assets/res1.webp')} alt="Little Lemon restaurant cuisine 2"></img>
            </section>
    </article>
    );
}